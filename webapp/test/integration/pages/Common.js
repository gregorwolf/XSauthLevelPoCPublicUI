sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("de/linuxdozent/gittest/publicui/app", ".html");
		...
		return Opa5.extend("de.linuxdozent.gittest.publicui.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["de/linuxdozent/gittest/publicui/localService/mockserver"], function (mockserver) {
